...
const account3 = {
  owner: 'Evtim Evtimov',
  movements: [5000, 3400, 250, -790, -3210, -1000, 8500, -30],
  interestRate: 1.5,
  pin: 3333,
  movementsDates: [
    '2019-11-01T13:15:33.035Z',
...
labelBalance.addEventListener('click', func);
*/
...
console.log(51253625321125261514215125n);
console.log(BigInt(51253625321125261514215125));

// Operations
console.log(10000n + 10000n);
console.log(61262385286832579352868238685854n * 1000000n);

const huge = 591868882682821626n;
const num = 23;
...
console.log(new Date('Nov 24 2022 12:41:19'));
...
console.log(new Date(1669287720054));
...
setInterval(function () {
  const now = new Date();
  // console.log(new Intl.NumberFormat('', now).format(task));
